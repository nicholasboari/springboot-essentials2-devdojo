...
class AnimeServiceTest {
    ...
    void listAll_ReturnsListOfAnimesInsideObject_WhenSuccessful() {
    ...
    void findByIdOrThrowBadRequestException_ReturnsAnime_WhenSuccessful() {
        ...
        Assertions.assertThat(anime.getId()).isEqualTo(anime.getId());
    }
    ...
    void findByName_ReturnsListOfAnime_WhenSuccessful() {
        ...
        List<Anime> animes = animeService.findByName("lkajsjdklas");
